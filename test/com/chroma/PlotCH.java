...
public class PlotCH extends PApplet {

	public static void main(String[] args) {
		String[] a = { "Main" };
		PApplet.runSketch(a, new PlotCH());
	}
	...
	public void draw() {
		...
		for (int i = 0; i < DOT_COUNT_X + 1; i++) {
			for (int j = 0; j < DOT_COUNT_Y + 1; j++) {
				...
				ellipse(map(i, 0, DOT_COUNT_X, DOT_SIZE_X / 2, CANVAS_X - DOT_SIZE_X / 2),
						map(j, 0, DOT_COUNT_Y, DOT_SIZE_Y / 2, CANVAS_Y - DOT_SIZE_Y / 2), DOT_SIZE_X, DOT_SIZE_Y);
			}
		}
	}
