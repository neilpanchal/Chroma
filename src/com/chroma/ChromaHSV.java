...
public class ChromaHSV extends ChromaColor {
    ...
    public ChromaHSV getChromaHSV() { return this;}
    public ChromaLAB getChromaLAB() { return new ChromaLAB(0, 0, 0, 0);}
    public ChromaLCH getChromaLCH() { return new ChromaLCH(0, 0, 0, 0);}
}
