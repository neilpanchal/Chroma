...
public class ChromaLAB extends ChromaColor {
	...
	public ChromaRGB getChromaRGB() {
		...
		double rgb_R_ = ChromaUtil.xyz_rgb(3.2404542 * x - 1.5371385 * y
				- 0.4985314 * z);
		double rgb_G_ = ChromaUtil.xyz_rgb(-0.9692660 * x + 1.8760108 * y
				+ 0.0415560 * z);
		double rgb_B_ = ChromaUtil.xyz_rgb(0.0556434 * x - 0.2040259 * y
				+ 1.0572252 * z);
	...
	public ChromaLCH getChromaLCH() {
		...
		double lch_C_ = Math.sqrt(Math.pow(this.lab_A, 2)
				+ Math.pow(this.lab_B, 2));
