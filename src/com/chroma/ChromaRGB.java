...
public class ChromaRGB extends ChromaColor {
    ...
    public ChromaRGB(double rgb_R_, double rgb_G_, double rgb_B_, double alpha_) {
        // this.rgb_R = ChromaUtil.clamp(rgb_R_, 0, 255);
        // this.rgb_B = ChromaUtil.clamp(rgb_B_, 0, 255);
        // this.rgb_G = ChromaUtil.clamp(rgb_G_, 0, 255);
        // this.alpha = ChromaUtil.clamp(alpha_, 0, 255);
        this.rgb_R = rgb_R_;
        this.rgb_G = rgb_G_;
        this.rgb_B = rgb_B_;
        this.alpha = alpha_;
    ...
    public ChromaLAB getChromaLAB() {
        ...
        return new ChromaLAB(116 * y - 16, 500 * (x - y), 200 * (y - z), alpha);
